import type { ProfileCategoryModalProps } from '../model/types'
import { useProfileCategoryModal } from '../model/hooks'
...
export const ProfileCategoryModal = ({
  ...
  const { tempSelected, setTempSelected } = useProfileCategoryModal(isOpen, initialSelectedValue)
